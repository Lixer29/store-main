                ...
                <Container>
                    <Navbar.Brand href="/">Online store</Navbar.Brand>
                        ...
                        {user.IsAuth ?
                            ...
                            :
                            <Nav className="gap-3">
                                <Nav.Link onClick={() => navigate('/login')}>Авторизація</Nav.Link>
                            </Nav>
                        }
                </Container>
            </Navbar>
